...
def check_packages():
    ...
    if (
        ...
        choice = input(
            f"\n{color.GREEN}Do you still want to continue to R16PH?{color.WHITE}     Y / N > "
        ).lower()
...
def get_screenshot():
    ...
    if screenshot_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving screenshot to R16-PH/{screenshot_location}\n{color.WHITE}"
        )
    else:
        print(
...
def screenrecord():
    ...
    if screenrecord_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving video to R16-PH/{screenrecord_location}\n{color.WHITE}"
        )
    else:
...
def pull_file():
    ...
    if pull_location == "":
        ...
        print(
            f"\n{color.PURPLE}Saving file to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_whatsapp():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving data to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_screenshots():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Screenshots to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
...
def copy_camera():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Photos to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_sms():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving SMS file to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_contacts():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Contacts file to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
...
def dump_call_logs():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving Call Logs file to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
        print(
...
def extract_apk():
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving APK file to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
...
def update_me():
    ...
    print(f"{color.CYAN}\nPlease restart R16-PH{color.WHITE}")
    exit_phonesploit_pro()
...
def record_audio(mode):
    ...
    if pull_location == "":
        pull_location = "Downloaded-Files"
        print(
            f"\n{color.PURPLE}Saving recordings to R16-PH/{pull_location}\n{color.WHITE}"
        )
    else:
