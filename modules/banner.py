"""
    ...
    Script :R16-PH - All in One Android Hacking ADB Toolkit  

    Copyright (C) 2023  R16 TEAM
...
menu3 = f"""
    ...
    {color.WHITE}34. {color.GREEN}Dump All Contacts           {color.WHITE}39. {color.GREEN}Use Keycodes (Control Device)       {color.WHITE}44. {color.GREEN}Update R16-PH
    {color.WHITE}35. {color.GREEN}Dump Call Logs              {color.WHITE}40. {color.GREEN}Listen Mic Audio                    {color.WHITE}45. {color.GREEN}Visit R16-PH on GitHub
...
{color.RED}[R16 PH]   {color.WHITE}Press 'Enter' to continue attack / '0' to Go Back to Main Menu
    """

banner2 = f"""

        ▄︻デ Team R 1 6 ══━一 ▄︻デ Team R 1 6 ══━一
        ▄︻デ Team R 1 6 ══━一 ▄︻デ Team R 1 6 ══━一
        ▄︻デ Team R 1 6 ══━一 ▄︻デ Team R 1 6 ══━一


            {color.RED}{version}{color.WHITE}            {color.WHITE}By R16 TEAM
"""
